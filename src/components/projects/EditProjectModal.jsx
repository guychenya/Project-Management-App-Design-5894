...
const EditProjectModal = ({ isOpen, onClose, project }) => {
  const { updateProject, teamMembers } = useProject();
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
                        errors.manager ? 'border-red-500 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'
                      } dark:bg-gray-700 dark:text-white`}
                    >
                      ...
                      {teamMembers.map(member => (
                        <label key={member.id} className="flex items-center space-x-2 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded">
                          <input
                            ...
                            onChange={() => handleTeamChange(member.id)}
                      ...
                      {colors.map(color => (
                        <button
                          ...
                          className={`w-8 h-8 rounded-full border-2 ${
                            formData.color === color ? 'border-gray-400 dark:border-gray-300' : 'border-gray-200 dark:border-gray-600'
                          }`}
